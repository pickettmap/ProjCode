...
insert into Users (userID,userName,password) values (%s,%s,%s);",(DEFAULT,'user1','123'),(DEFAULT,'user2','password111'),(DEFAULT,'user3','CUBoulder');
...
insert into Pictures (picID,picName,userID) values (%s,%s,%s);",
...
insert into Tags (TagID, TagName) values (%s,%s);",(DEFAULT,'mom'),(DEFAULT,'selfie'),(DEFAULT,'me'),(DEFAULT,'Chip');
...
insert into PicturesTags (picID,tagID) values (%s,%s);",(1,3),(1,4),(2,2),(2,1),(3,3),(4,1),(5,3),(6,1),(6,2),(7,4),(8,3),(9,2);
